    ...
    <section className=" font-lora relative overflow-hidden py-6 md:py-1 min-h-[1200px]  md:min-h-[1200px] lg:min-h-[950px] bg-[url('/images/home/team/team_bg.webp')] bg-no-repeat bg-center bg-cover z-30 ">
      <Container>
        ...
        <div className="flex flex-col sm:flex-row mt-10 pt-10">
          <div className=" px-4 sm:px-12 order-first sm:order-last mb-6 sm:mb-0">
          ...
          <div className="flex flex-col sm:flex-row max-w-6xl sm:max-w-4xl mx-auto border-b-2 border-t-2">
        ...
        <div className="w-full grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6 mt-10 sm:mt-16">
          <div className="bg-primary rounded-3xl p-2 sm:p-6 shadow-lg">
          ...
          <div className="bg-second rounded-3xl p-2 sm:p-6 shadow-lg">
            <div className="flex justify-between text-white p-4">
              <div>
          ...
          <div className="bg-third rounded-3xl p-2 sm:p-6 shadow-lg">
            <div className="flex justify-between text-white p-4">
              <div>
          ...
          <div className="bg-fourth rounded-3xl p-2 sm:p-6 shadow">
            <div className="flex justify-between text-white p-4">
              <div>
