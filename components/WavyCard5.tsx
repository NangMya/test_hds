...
const WavyCard5 = ({ children }: Props) => {
  return (
<div className="relative w-full h-auto min-h-[450px] sm:min-h-[550px] md:min-h-[770px] overflow-hidden">
      <svg
    className="absolute inset-0 -z-10 w-full h-[620px] sm:h-[950px] lg:h-full"
